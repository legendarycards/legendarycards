...
description: The holofoil is corrected to not show the evolution box outline and a second corrected version was released using the Cosmos holofoil pattern.
category: rare
set: fossil-unlimited
multi: true
cards: corrected, thunderstorm
topvault: 383e2e50-1329-4a59-b2dd-2318e5721da3, da6ed14e-b1b5-42c5-b5eb-0c89cccbf0dc
---
...
The first run uses a "1999" copyright and the second uses "1999-2000".
The rarer version of this card is the "1999" copyright variant.
